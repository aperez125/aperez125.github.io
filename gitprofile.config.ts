...
const CONFIG = {
  github: {
    username: 'aperez125', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['aperez125/Bioinformatics', 'aperez125/projects'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://aperez125.github.io',
    phone: '',
    email: 'anateresaa1601@gmail.com',
  },
  resume: {
    fileUrl:
      'https://aperez125.github.io/pdfs/aperezCV.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
